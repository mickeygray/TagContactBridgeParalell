...
function isRetryableSuperviseError(error) {
  ...
  return /No (active|live) agent telephonySessionId|MBW-005|Your call cannot be connected|TAS-120|TAS-102|WrongState|Incorrect State|CMN-10[12]|agentExtensionId/i
    .test(message);
}
